...
import details from '../Images/travel/photo-1526772662000-3f88f10405ff.jpg'
...
const DetailsVeiw = () => {
    ...
    return (
        <div>
            <div style={{
                background: `linear-gradient(rgba(0,0,0,.25),rgba(0,0,0,.25)),url(${details}) center center/cover fixed no-repeat`, overflow: "hidden",
            }}
